...
#			print("DEBUG: here are the compiler-created node instructions:")
#			var readable_instructions = []
#			for instruction in nodeCompiled.instructions:
#				readable_instructions.append(instruction.operation)
#			print(readable_instructions)
